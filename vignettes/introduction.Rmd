...
library(knitr)
setwd("~/Dropbox (SMCP)/DARAWAN/Module analysis/R packages/BloodGen3Module/")
...
## Input
  ***
To perform the modular repertoire analysis, the R package simply requires a sample annotation table and a normalized expression data matrix For illustrative purposes sample input files can be downloaded here; https://github.com/Drinchai/BloodGen3Module/tree/master/data.

```{r raw data and annotaion preparation, echo= TRUE}
...
```{r fingerprint visualization, warning=FALSE, echo= TRUE}
